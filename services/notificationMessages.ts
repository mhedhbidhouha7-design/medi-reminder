...
export const getNotificationContent = (
  ...
  const messages: Record<NotificationType, NotificationContent> = {
    medication_reminder_30: {
      ...
      sms: `⏰ Rappel Proche : Votre proche doit prendre ${medicationName} (${dose}) dans 30 minutes.`,
    },
    medication_reminder_15: {
      ...
      sms: `⚠️ Rappel Proche : Votre proche doit prendre ${medicationName} (${dose}) dans 15 minutes.`,
    },
    medication_dose: {
      ...
      sms: `🚨 Rappel Proche : Il est l'heure pour votre proche de prendre son médicament : ${medicationName} (${dose}).`,
    },
    appointment_2d: {
      ...
      sms: `📅 Rappel RDV Proche : Votre proche a un rendez-vous (${appointmentTitle}) dans 2 jours (le ${date} à ${time}).`,
    },
    appointment_1d: {
      ...
      sms: `⚠️ Rappel RDV Proche : Votre proche a un rendez-vous (${appointmentTitle}) demain à ${time}.`,
    },
    appointment_5h: {
      ...
      sms: `⏰ Rappel RDV Proche : Votre proche a un rendez-vous (${appointmentTitle}) dans quelques heures (à ${time}).`,
    },
    appointment_now: {
      title: "🚀 C'est l'heure !",
      ...
      sms: `🚨 Rappel RDV Proche : Votre proche a un rendez-vous/devoir : ${appointmentTitle} à ${time}.`,
    },
  };
